...
- Name: app.spec.ts >> beacon → tl recorded → clip auto-aligned at record stop
- Location: e2e/app.spec.ts:98:5
...
```ts
  ...
  65  | 
  66  |     const clip = page.locator('.clip')
  ...
  105 |     sock.send(oscMessage('/tap/timeline', [tl]), BEACON_PORT, '127.0.0.1')
  106 |   }, 100)
  107 |   try {
  108 |     await expect(page.locator('.chip', { hasText: 'beacon tl=' })).toBeVisible({
  109 |       timeout: 5000
  110 |     })
  ...
  117 | 
  118 |     const clip = page.locator('.clip')
